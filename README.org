...
OPTIONS:
    -d, --dry
            Dry run (don't actually change files or do git commits/tags)

    -h, --help
            Print help information

        --minortokens [<MINORTOKENS>...]
            Tokens that trigger a patch level bump; comma separated list [default: feat,feature]

        --patchtokens [<PATCHTOKENS>...]
            Tokens that trigger a patch level bump; comma separated list [default: fix]

    -t, --tag [<TAGPREFIX>...]
            Prefix of the tags to be matched [default: ]
